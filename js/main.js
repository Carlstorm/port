...
function showtextbut(dis, changetext) {
    ...
    if (dis == 0) {
        ...
        if (document.getElementsByClassName("butimg")[dis].src.includes("Cross")) {
            ...
            document.getElementsByClassName("wawawa")[dis].innerHTML = "Mit arbejde"
        }
        document.getElementsByClassName("wawawa")[dis].style.clipPath = "polygon(0% 0, 100% 0, 100% 100%, 0% 100%)"
...
// document.getElementById("Omig").addEventListener("mouseover", function (event) {
//     whatbutText = 0
//     show = true;
//     whatbut = this
//         document.getElementById("Omig").style.opacity = 1
//         if (!toggler2) {
//         document.getElementById("Omig").style.transform = "scale(1.4)"
//         }
//     if (toggler2) { 
//         showtextbut(whatbutText)
//     }
// })


// let opacityamount = 0.33;
// document.getElementById("Omig").addEventListener("mouseleave", function (event) {
//     show = false;
//     whatbut = this
//         if (toggler2) {
//         document.getElementById("Omig").style.opacity = 0.3
//         } else {
//         document.getElementById("Omig").style.opacity = 0.75
//         document.getElementById("Omig").style.transform = "scale(1)"
//         }
//     hidetextbut(whatbutText)
// })



// document.getElementById("PortMen").addEventListener("mouseover", function (event) {
//     whatbutText = 1
//     show2 = true;
//     whatbut = this
//         opacityamount = 1;
//         document.getElementById("PortMen").style.opacity = opacityamount;
//         if (!toggler) {
//         document.getElementById("PortMen").style.transform = "scale(1.4)"
//         }
//     if (toggler) { 
//         showtextbut(whatbutText)
//     }
...
// document.getElementById("PortMen").addEventListener("mouseleave", function (event) {
//     show2 = false;
//     whatbut = this
//         if (toggler) {
//         opacityamount = 0.33;
//         } else {
//         document.getElementById("PortMen").style.opacity = 0.75
//         document.getElementById("PortMen").style.transform = "scale(1)"
//         }
//     hidetextbut(whatbutText)
// })


// document.getElementById("mail").addEventListener("mouseover", function (event) {
//     whatbutText = 2
//     // showtextbut(whatbutText)
// })

// document.getElementById("mail").addEventListener("mouseleave", function (event) {
//     // hidetextbut(whatbutText)
// })
...
document.getElementsByClassName("bgimg")[1].style.backgroundImage = "url(../imgs/notdoebg.jpg)"
